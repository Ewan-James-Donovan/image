...
describe('Circle', function () {
    ...
    it('should render with a tag and attributes', function () {
        ...
        sc.circle()
            ...
            .fillOpacity("50%")
            .strokeOpacity("70%");
        expect(sc.render(true)).toBe("<svg style=\"width: 100%; height: 100%; background-color: rgba(0,0,0,0);\"><circle r=\"6px\" cx=\"5px\" cy=\"9px\" fill=\"red\" fill-opacity=\"50%\" stroke=\"green\" stroke-width=\"2px\" stroke-linecap=\"square\" stroke-dasharray=\"1, 3, 5, 9\" stroke-opacity=\"70%\"></circle></svg>");
    });
...
describe('Rectangle', function () {
    ...
    it('should render with a tag and attributes', function () {
        ...
        sc.rectangle()
            ...
            .strokeOpacity("70%")
            .roundCorners("2px");
        expect(sc.render(true)).toBe("<svg style=\"width: 100%; height: 100%; background-color: rgba(0,0,0,0);\"><rect width=\"100px\" height=\"75px\" x=\"5px\" y=\"9px\" fill=\"red\" fill-opacity=\"50%\" stroke=\"green\" stroke-width=\"2px\" stroke-linecap=\"square\" stroke-dasharray=\"1, 3, 5, 9\" stroke-opacity=\"70%\" rx=\"2px\" ry=\"2px\"></rect></svg>");
    });
...
describe('Line', function () {
    ...
    it('should render with a tag and attributes', function () {
        ...
        sc.line()
            ...
            .dash("1, 3, 5, 9")
            .strokeOpacity("70%");
        expect(sc.render(true)).toBe("<svg style=\"width: 100%; height: 100%; background-color: rgba(0,0,0,0);\"><line x1=\"5px\" x2=\"11px\" y1=\"2px\" y2=\"15px\" stroke=\"green\" stroke-width=\"2px\" stroke-linecap=\"square\" stroke-dasharray=\"1, 3, 5, 9\" stroke-opacity=\"70%\"></line></svg>");
    });
...
describe('Path', function () {
    ...
    it('should render with a tag and attributes', function () {
        ...
        sc.path()
            ...
            .fill("lime")
            .fillOpacity("30%");
        expect(sc.render(true)).toBe("<svg style=\"width: 100%; height: 100%; background-color: rgba(0,0,0,0);\"><path d=\"M 50 50 L 50 50 L 300 300 L 590 590\" stroke=\"green\" stroke-width=\"2px\" stroke-linecap=\"square\" stroke-dasharray=\"1, 3, 5, 9\" stroke-opacity=\"70%\" fill=\"lime\" fill-opacity=\"30%\"></path></svg>");
    });
...
describe('Text', function () {
    ...
    it('should render with a tag, attributes, and content', function () {
        ...
        sc.text()
            ...
            .font("consolas")
            .size("20pt");
        expect(sc.render(true)).toBe("<svg style=\"width: 100%; height: 100%; background-color: rgba(0,0,0,0);\"><text x=\"320px\" y=\"320px\" fill=\"blue\" fill-opacity=\"50\" stroke=\"black\" stroke-width=\"5px\" stroke-linecap=\"round\" stroke-dasharray=\"3 4 5\" stroke-opacity=\"50%\" font-family=\"consolas\" font-size=\"20pt\">testing</text></svg>");
    });
