...
export default class Polygon extends AbstractCanvasObject {
    ...
    // rotate(radians) {
    //     this.startAngle(this.startAngleValue + radians);
    //     this.endAngle(this.endAngleValue + radians);
    //     return this;
    // }
